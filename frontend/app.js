  ...
  function fallbackReply(userText) {
    ...
    const fallbackTopics = {
      en: {
        ...
        property: '<strong>Property & Rent Issues:</strong><br><br>Landlord not returning deposit, illegal eviction, rent agreement disputes, builder delay, and property fraud.<br><br><strong>What to do:</strong> collect agreement and payment proof, send legal notice.<br><br><strong>Where to file:</strong> Civil Court / Rent Tribunal, Consumer Court (builder cases).<br><br><strong>Documents Needed:</strong> rent agreement, payment receipts, bank statement, chats/emails, photos/videos.',
        family: '<strong>Family Issues:</strong><br><br>Divorce, domestic violence, child custody, and dowry harassment.<br><br><strong>What to do:</strong> approach police or authority, document evidence.<br><br><strong>Where to file:</strong> Family Court / Police Station.<br><br><strong>Documents Needed:</strong> marriage certificate, medical reports, chats/recordings, income proof.',
        employment: '<strong>Employment Issues:</strong><br><br>Salary not paid, wrongful termination, and workplace harassment.<br><br><strong>What to do:</strong> collect emails and offer letter, raise internal complaint.<br><br><strong>Where to file:</strong> Labour Court / ICC (for harassment).<br><br><strong>Documents Needed:</strong> offer letter, salary slips, bank statement, emails.',
        traffic: '<strong>Traffic Issues:</strong><br><br>Accidents, vehicle theft, and insurance claim issues.<br><br><strong>What to do:</strong> gather evidence, contact police.<br><br><strong>Where to file:</strong> Traffic Police / MACT Tribunal.<br><br><strong>Documents Needed:</strong> driving license, RC, insurance, FIR.',
        finance: '<strong>Financial Issues:</strong><br><br>Bank fraud, cheque bounce, and loan harassment.<br><br><strong>What to do:</strong> inform bank immediately, keep proof.<br><br><strong>Where to file:</strong> RBI Ombudsman / Police.<br><br><strong>Documents Needed:</strong> bank statement, cheque + memo, loan documents.',
